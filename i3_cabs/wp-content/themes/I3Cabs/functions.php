...
function twentyseventeen_setup() {
	...
	register_nav_menus(
		array(
			...
			'quick-links'    => __( 'Quick-Links Menu', 'twentyseventeen' ),
...
function twentyseventeen_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Contact', 'twentyseventeen' ),
			'id'            => 'footer-contact',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Icons', 'twentyseventeen' ),
			'id'            => 'footer-icons',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Contact us Email', 'twentyseventeen' ),
			'id'            => 'contact-us-email',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Contact Us Address', 'twentyseventeen' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Contact-us-Phone', 'twentyseventeen' ),
			'id'            => 'contact-us-phone',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
